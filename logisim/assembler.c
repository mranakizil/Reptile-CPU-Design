...
//========================================   FIRST PASS  ======================================================
            while (token)
            {
                ...
                else if (strcmp(token,"sub")==0)
                {
                    ...
                    op3 = strtok(NULL,"\n\t\r ");
                    chch = (op2[0]-48)| ((op1[0]-48)<<3)|((op3[0]-48)<<6);
                    program[counter]=0x7100+((chch)&0x01ff);
                    counter++;
                }
                ...
                else if (strcmp(token,"or")==0)
                {
                    ...
                    op3 = strtok(NULL,"\n\t\r ");
                    chch = (op2[0]-48)| ((op1[0]-48)<<3)|((op3[0]-48)<<6);
                    program[counter]=0x7300+((chch)&0x01ff);
                    counter++;
                }
                ...
                // 0111 1010 00xx xxxx
                    ...
                    program[counter]=0x7a00+((ch)&0x003f);
                    counter++;
                }
				...
				// 0111 1010 01xx xxxx
                    ...
                    op2 = strtok(NULL,"\n\t\r ");
                    ch = (op1[0]-48)| ((op2[0]-48)<<3);
                    program[counter]=0x7a40+((ch)&0x003f);
                    counter++;
                }
                ...
                // 0111 1010 10xx xxxx
                    ...
                    program[counter]=0x7a80+((ch)&0x003f);
                    counter++;
                }
                ...
                { 
                    op1 = strtok(NULL,"\n\t\r ");
                    ch = (op1[0]-48)| ((op1[0]-48)<<3);
                    program[counter]=0x7ac0+((ch)&0x003f);
                    counter++;
                }
